...
const Pies: Pie[] = [
	{ id: 0, src: Pie_1, width: 31, top: -38, left: 41.7 },
	{ id: 1, src: Pie_2, width: 50, top: -29.8, left: 43 },
	{ id: 2, src: Pie_3, width: 48, top: 7, left: 43 },
	{ id: 3, src: Pie_4, width: 32.5, top: 10.5, left: 41.7 },
	{ id: 4, src: Pie_5, width: 34, top: 11, left: 13.5 },
	{ id: 5, src: Pie_6, width: 50, top: 10, left: -6, z: 3 },
	{ id: 6, src: Pie_7, width: 48, top: -24.5, left: -4.5, z: 2 },
	{ id: 7, src: Pie_8, width: 28, top: -37, left: 15, z: 1 }
]
const PIES = {
	Pies,
	Plate,
